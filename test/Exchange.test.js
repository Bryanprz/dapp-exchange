import { ether, tokens, EVM_MESSAGE, ETHER_ADDRESS } from './helpers';
...
contract('Exchange', ([deployer, feeAccount, user1, user2]) => {
  ...
  describe('depositEther', () => {
    ...
    it('emits a Deposit event', async () => {
      ...
      event.amount.toString().should.eq(ether(1).toString(), 'amount is correct');
  ...
  describe('depositing tokens', () => {
    ...
    describe('failure', () => {
      it('rejects Ether deposits', async () => {
        await exchange.depositToken(ETHER_ADDRESS, amount, { from: user1 }).should.be.rejectedWith(EVM_MESSAGE);
      });
  ...
  describe('withdrawing tokens', async () => {
    ...
    describe('failure', async () => {
      ...
      it('fails for insufficient funds', async () => {
        await exchange.withdrawToken(token.address, tokens(10), { from: user1 }).should.be.rejectedWith(EVM_MESSAGE);
      });
  ...
  describe('making orders', async () => {
    ...
    it('tracks the newly created order',async () => {
      ...
      // use orderCount '1' to check attrs of order
